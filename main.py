...
print(Style.BRIGHT + Fore.BLUE + "======================================")
print(Style.BRIGHT + Back.GREEN + Fore.BLACK + "Resumo do processo")
print(Style.BRIGHT + Fore.BLUE + f"Tempo total: {tempo_total:.2f} segundos")
print(Style.BRIGHT + Fore.GREEN + f"Pastas encontradas: {pastas_encontradas}")
...
print(Style.BRIGHT + Fore.GREEN + f"Pastas criadas: {pastas_criadas}")
print(Style.BRIGHT + Fore.RED + f"Pastas deletadas: {pastas_deletadas}")
print(Style.BRIGHT + Fore.MAGENTA + f"Arquivos movidos: {arquivos_movidos}")
print(Fore.YELLOW + f"Arquivos renomeados: {arquivos_renomeados}")
